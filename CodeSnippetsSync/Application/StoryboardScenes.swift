...
internal enum StoryboardScene {
  internal enum Authorization: StoryboardType {
    ...
    internal static let authorizationViewController = SceneType<CodeSnippetsSync.AuthorizationViewController>(storyboard: Self.self, identifier: "AuthorizationViewController")

    internal static let authorizationWindowController = SceneType<CodeSnippetsSync.AuthorizationWindowController>(storyboard: Self.self, identifier: "AuthorizationWindowController")
  }
}
