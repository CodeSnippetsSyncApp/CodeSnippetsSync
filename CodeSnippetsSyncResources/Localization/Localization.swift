...
public enum L10n {
  ...
  public enum Authorization {
    ...
    /// XcodeSnippetsSync is sandboxed and does not have access to any directory other than its own container. Applications that do not authorize Xcode's UserData directory will not work.
    public static let detail = L10n.tr("Localizable", "Authorization.Detail", fallback: "XcodeSnippetsSync is sandboxed and does not have access to any directory other than its own container. Applications that do not authorize Xcode's UserData directory will not work.")
  ...
  public enum Sandbox {
    public enum OpenPanel {
      /// Please allow XcodeSnippetsSync to access this directory
      public static let message = L10n.tr("Localizable", "Sandbox.OpenPanel.Message", fallback: "Please allow XcodeSnippetsSync to access this directory")
      /// Allow
